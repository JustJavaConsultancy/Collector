...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches CREATE_SUBSCRIBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SUBSCRIBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SUBSCRIBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SUBSCRIBER actions', async () => {
      const expectedActions = [
        {
