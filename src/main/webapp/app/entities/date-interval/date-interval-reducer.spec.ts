...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DATEINTERVAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_DATEINTERVAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DATEINTERVAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DATEINTERVAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DATEINTERVAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DATEINTERVAL actions', async () => {
      const expectedActions = [
        {
