...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './facility.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FACILITY_LIST actions', async () => {
    ...
    it('dispatches FETCH_FACILITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FACILITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FACILITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FACILITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FACILITY actions', async () => {
      const expectedActions = [
        {
