...
export class SubscriberDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('collectorApp.subscriber.delete.question'));
...
export default class SubscriberComponentsPage {
  ...
  async deleteSubscriber() {
    ...
    expect(await subscriberDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/collectorApp.subscriber.delete.question/);
