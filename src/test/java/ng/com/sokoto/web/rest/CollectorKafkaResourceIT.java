...
import ng.com.sokoto.config.EmbeddedKafka;
...
@WithMockUser
@EmbeddedKafka
class CollectorKafkaResourceIT {
    ...
    void producesMessages() throws InterruptedException {
        client.post().uri("/api/collector-kafka/publish?message=value-produce").exchange().expectStatus().isNoContent();
    ...
    void consumesMessages() {
        ...
        String value = client
            .get()
            .uri("/api/collector-kafka/consume")
